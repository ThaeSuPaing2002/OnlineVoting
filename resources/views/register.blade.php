            ...
            <div class="h-fit m-5 bg-white border rounded">
                ...
                <form class="m-5 p-5" action="" method="" >
                    ...
                    <div class="mb-6">
                        ...
                        <input type="password" id="c_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg ring-1 ring-purple-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="text-center font-normal"><small>Already registered? <a href="{{route('loginPage')}}" class="font-bold underline text-purple-500">Sign in Here!</a></small></div>
                    </div>
                </form>
